...
class PetAvatarCard(CardWidget):
    ...
    def _init_ui(self):
        ...
        self.quote_label.setText(tr("widget.pet_avatar.default_quote", default="今天心情怎么样呢？"))
        ...
        self.status_label.setText(tr("widget.pet_avatar.default_status", default="状态良好"))
